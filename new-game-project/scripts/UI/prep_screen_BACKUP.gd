...
func _on_inventory_pressed() -> void:
	update_help_text("Manage convoy and distribute items to units.")
	# TODO: Show inventory panel (deferred)
	DebugLog.log("Inventory - Not yet implemented", "yellow")
